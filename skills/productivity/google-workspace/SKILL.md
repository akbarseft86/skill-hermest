...
- `references/google-sheets-csv-export.md` — no-auth CSV export pattern for public Google Sheets shared with “anyone with the link”. Use this before OAuth/API setup when the task is read-only extraction from a public spreadsheet.
